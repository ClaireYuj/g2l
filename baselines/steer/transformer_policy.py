...
from baselines.steer.steer import Steer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_dim, share_obs_dim, act_space, num_agents, device=torch.device("cpu")):
        self.device = device
    ...
    def lr_decay(self, episode, episodes):
        ...
        """
        return update_linear_schedule(self.optimizer, episode, episodes, self.lr)
