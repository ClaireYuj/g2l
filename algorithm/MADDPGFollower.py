...
class CCMADDPG(object):
    def __init__(self,n_agents, state_dim, action_dim, seq_len, action_lower_bound,
        ...
        self.actors = [ActorNetwork(self.state_dim, self.action_dim, self.actor_output_activation).to(self.device)] * self.n_agents
